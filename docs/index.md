# Welcome to the Zero to Mastery PyTorch for Deep Learning Book (work in progress)

This will be the homepage for the online book version of the Zero to Mastery Deep Learning with PyTorch course.
